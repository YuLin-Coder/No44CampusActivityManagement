...
<form method="post" action="" id="listform">
  <div class="panel admin-panel">
    <div class="panel-head"><strong class="icon-reorder">学科资源列表</strong></div>
    <div class="padding border-bottom">
      <ul class="search">
        <li>
           <a class="button border-main icon-plus-square-o" href="${ctx }/xkzy/add.do"> 添加</a> 
        </li>
         <li>
          </li>
      </ul>
	...
	private User addUser;//添加人 -->
        ...
        <tr>
           ...
           <td>
              ...
              <a class="button border-main" href="/ssm_xymh_sys/xkzy/update.do?id=${data.id}"><span class="icon-edit"></span>修改</a> 
...
function del(id){
	if(confirm("您确定要删除吗?")){
		window.location.href="/ssm_xymh_sys/xkzy/delete.do?id="+id;
	}
}
function DelSelect(){
	var Checkbox=false;

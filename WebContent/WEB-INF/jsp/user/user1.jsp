...
<body>
<form method="post" action="/ssm_xymh_sys/user/findByMap.do?type=1" id="listform">
  <div class="panel admin-panel">
    <div class="panel-head"><strong class="icon-reorder">教师列表</strong></div>
    <div class="padding border-bottom">
      <ul class="search">
        <li>
           <a class="button border-main icon-plus-square-o" href="${ctx }/user/add.do?type=1"> 添加</a> 
        </li>
         <li>
      ...
      <tr>
        ...
        <tr>
           ...
           <td>
              ...
              <a class="button border-main" href="/ssm_xymh_sys/user/update.do?type=1&id=${data.id}"><span class="icon-edit"></span>修改</a> 

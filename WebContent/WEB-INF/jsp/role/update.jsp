...
<div class="panel admin-panel margin-top">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="/ssm_xymh_sys/role/exUpdate.do" enctype="multipart/form-data"> 
    <input type="hidden" name="id" value="${obj.id}">  
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" name="jieshi" value="${obj.jieshi }" data-validate="required:请输入名称解释" />         
          <div class="tips"></div>
        </div>
      </div> 
     <div class="form-group">

...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
   ...
   <title>易购后台管理中心</title>  
    ...
    <script src="/ssm_xymh_sys/resource/js/jquery.js"></script>
     ...
     <script language="javascript" type="text/javascript" src="/ssm_xymh_sys/resource/js/My97DatePicker/WdatePicker.js"></script> 
</head>
<style>
    .file1 {
        position: relative;
...
<div class="panel admin-panel margin-top">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="/ssm_xymh_sys/xl/exUpdate.do" enctype="multipart/form-data"> 
    ...
    <div class="form-group">
        ...
        <div class="field">
         <input class="Wdate" type="text" onClick="WdatePicker()" name="riqi" value="${obj.riqi }">         
          <div class="tips"></div>
        </div>
      </div> 
      <div class="form-group">
        ...
        <div class="field">
          <textarea class="input" name="content" style=" height:90px;">${obj.content}</textarea>
          <div class="tips"></div>
        </div>
      </div>
     <div class="form-group">

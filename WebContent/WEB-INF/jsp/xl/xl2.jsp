					...
					<div class="ic_wrap fr">
						<ul class="news_list">
						 <c:forEach items="${pagers.datas}" var="data" varStatus="l">
		                 	<li><a>${data.content}</a><span class="date">[
		                 	${data.riqi}
		                 	</span></li>
		                 </c:forEach>
						</ul>
						...
						<div class="record">
	                        <!-- 分页开始 -->
			      <pg:pager  url="/ssm_xymh_sys/xl/findByObj2.do" maxIndexPages="5" items="${pagers.total}"  maxPageItems="15" export="curPage=pageNumber" >
					<pg:last>  

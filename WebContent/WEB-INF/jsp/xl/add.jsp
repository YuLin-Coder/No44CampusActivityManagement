...
<div class="panel admin-panel margin-top">
  <div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span>日历</strong></div>
  <div class="body-content">
    <form method="post" class="form-x" action="/ssm_xymh_sys/xl/exAdd.do" enctype="multipart/form-data"> 
      <div class="form-group">
        <div class="label">
          <label>日期：</label>
        </div>
        <div class="field">
         <input class="Wdate" type="text" onClick="WdatePicker()" name="riqi">         
          <div class="tips"></div>
        </div>
      </div> 
      <div class="form-group">

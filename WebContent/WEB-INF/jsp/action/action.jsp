...
<form method="post" action="" id="listform">
  <div class="panel admin-panel">
    ...
    <div class="padding border-bottom">
      <ul class="search">
        <li>
           <a class="button border-main icon-plus-square-o" href="${ctx }/action/add.do"> 添加</a> 
        </li>
         <li>
          </li>
      </ul>
    ...
    <table class="table table-hover text-center">
      <tr>
        ...
        <tr>
           ...
           <td>
              ...
              <a class="button border-main" href="/ssm_xymh_sys/action/update.do?id=${data.id}"><span class="icon-edit"></span>修改</a> 
      ...
      <tr>
        ...
        <!-- 分页开始 -->
			      <pg:pager  url="/ssm_xymh_sys/action/findByObj.do" maxIndexPages="5" items="${pagers.total}"  maxPageItems="15" export="curPage=pageNumber" >
					<pg:last>  
...
function del(id){
	if(confirm("您确定要删除吗?")){
		window.location.href="/ssm_xymh_sys/action/delete.do?id="+id;
	}
}
function DelSelect(){
	var Checkbox=false;

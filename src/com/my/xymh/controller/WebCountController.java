...
public class WebCountController extends BaseController {
	...
	public String exAdd(WebCount webCount, Model model, HttpServletRequest request, HttpServletResponse response) {
		webCountService.insert(webCount);
		return "redirect:/webCount/findByObj.do";
	}
	...
	public String update(Integer id,Model model) {
		WebCount obj = webCountService.load(id);
		model.addAttribute("obj",obj);
		return "webCount/update";
	}
	...
	public String exUpdate(WebCount webCount, Model model, HttpServletRequest request, HttpServletResponse response) {
		webCountService.update(webCount);
		return "redirect:/webCount/findByObj.do";
	}
	...
	public String delete(Integer id, Model model, HttpServletRequest request, HttpServletResponse response) {
		//真正删除
		webCountService.deleteById(id);
		//通过参数删除
        //Map<String,Object> params = new HashMap<String,Object>();
		//params.put("id", id);
		//webCountService.deleteBySqId("deleteBySql", params);
		//状态删除
	...
	@ResponseBody
	public String findByObjByEntity(WebCount webCount, Model model, HttpServletRequest request, HttpServletResponse response) {
		//分页查询
		Pager<WebCount> pagers = webCountService.findByEntity(webCount);
	...
	@ResponseBody
	public String exUpdateJson(WebCount webCount, Model model, HttpServletRequest request, HttpServletResponse response) {
		webCountService.update(webCount);
		JSONObject jsonObject = JsonUtil2.getJsonObject();
